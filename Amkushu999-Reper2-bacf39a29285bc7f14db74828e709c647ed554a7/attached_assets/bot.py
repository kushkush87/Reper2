...
content_filters = {
    "enabled": BOT_CONFIG.get("content_filters_enabled", False),
    "keywords": {
        "include": BOT_CONFIG.get("filter_include_keywords", []),
        "exclude": BOT_CONFIG.get("filter_exclude_keywords", [])
    },
    "media_types": {
        "include": BOT_CONFIG.get("filter_include_media", []),
    ...
    if message.media:
        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(delete=False, suffix=extension) as tmp_file:
                ...
                # The default chunk size is too small for larger files
                download_options = {
                    'file': file_path,
                ...
                await message.download_media(**download_options)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    channel_buttons = [
        ...
        [InlineKeyboardButton("⚙️ Channel Management", callback_data="channel_management")]
    ]
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if query.data == "add_source":
    ...
    elif query.data == "channel_management":
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("➕ Join/Add Channel", callback_data="add_channel_management")],
            
            # Channel Maintenance Tools
            [InlineKeyboardButton("🧹 Channel Cleanup Tools", callback_data="channel_cleanup_menu")],
            [InlineKeyboardButton("⚙️ Channel Settings", callback_data="channel_settings_menu")],
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("◀️ Back to Channel Management", callback_data="channel_management")]
        ]
        ...
        status_msg = await query.edit_message_text(
            text,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("◀️ Back", callback_data="channel_management")]])
        )
            ...
            if not user_client or not user_client.is_connected():
                await status_msg.edit_text(
                    ...
                    reply_markup=InlineKeyboardMarkup([
                        ...
                        [InlineKeyboardButton("◀️ Back", callback_data="channel_management")]
                    ])
                )
                return
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # Use the user client to delete messages because it has admin rights
                    ...
                    if purge_and_leave:
                        try:
                            ...
                            # Send the farewell sticker
                            await user_client.send_file(
                                channel_entity,
                                farewell_sticker_id,
                                caption="👋 Goodbye! Channel cleanup completed."
                            )
                            
                            # Leave the channel
                            await status_msg.edit_text(
                                "👋 Posting farewell sticker and leaving channel..."
                            )
                            
                            # Small delay to make sure sticker is posted before leaving
